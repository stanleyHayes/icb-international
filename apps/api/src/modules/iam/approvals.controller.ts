 ...
 * control. Deciding is the sensitive act: it requires a fresh step-up proof, and the service
 * enforces the two rules that make four-eyes real (never your own request, never after
 * expiry). The decider is the token subject, never a value from the request.
 */
...
export class ApprovalsController {
  ...
  @RequireStepUp(STEP_UP_PURPOSES.approvalDecide)
