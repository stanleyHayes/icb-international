...
/**
 * Destructive and irreversible, so it confirms first. Everything else in ICB is one tap;
 * this one costs the customer their session on every device, including the one they are on.
 */
