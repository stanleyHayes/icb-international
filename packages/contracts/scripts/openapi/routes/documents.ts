...
export const documentsOperations = defineOperations([
  {
    method: 'get', path: '/documents/statements', tag: TAG.documents, operationId: 'listStatements',
  ...
  {
    method: 'post', path: '/documents/statements', tag: TAG.documents, operationId: 'generateStatement',
  ...
  {
    method: 'get', path: '/documents/statements/{statementId}/download', tag: TAG.documents,
    operationId: 'downloadStatement', summary: 'A short-lived signed download URL',
  ...
  {
    method: 'get', path: '/documents', tag: TAG.documents, operationId: 'listDocuments',
    summary: 'Tax documents, letters, and contracts',
    response: success(STATUS.ok, 'All documents.', z.array(documentSchema)),
  },
  {
    method: 'get', path: '/documents/{documentId}/download', tag: TAG.documents,
    operationId: 'downloadDocument', summary: 'A short-lived signed download URL',
