...
export const simulationOperations = defineOperations([
  ...
  },
  {
    ...
    response: success(STATUS.ok, 'All rail profiles.', itemsEnvelopeSchema(railProfileSchema)),
  },
  {
    method: 'patch',
  ...
  },
  {
    ...
    response: success(STATUS.ok, 'Runnable scenarios.', itemsEnvelopeSchema(scenarioSchema)),
  },
  {
    method: 'post',
    path: '/simulation/scenarios/runs',
    tag: TAG.simulation,
  ...
  {
    method: 'post',
    path: '/simulation/ledger/verification',
    tag: TAG.simulation,
  ...
  {
    method: 'get',
    path: '/simulation/flags',
    tag: TAG.simulation,
    operationId: 'listFeatureFlags',
    summary: 'Runtime feature flags',
    response: success(STATUS.ok, 'All flags.', itemsEnvelopeSchema(featureFlagSchema)),
  },
  {
    method: 'patch',
    path: '/simulation/flags/{flagKey}',
    tag: TAG.simulation,
    operationId: 'updateFeatureFlag',
    summary: 'Toggle or roll out a flag',
    pathParams: { flagKey: z.string().min(1).max(80) },
