...
export const paymentsOperations = defineOperations([
  {
    method: 'get', path: '/payments/billers', tag: TAG.payments, operationId: 'listBillers',
  ...
  {
    method: 'get', path: '/payments/bills', tag: TAG.payments, operationId: 'listLinkedBills',
    summary: 'Bills the customer has linked',
    response: success(STATUS.ok, 'Linked bills with due amounts.', z.array(linkedBillSchema)),
  },
  {
    method: 'post', path: '/payments/bills', tag: TAG.payments, operationId: 'linkBill',
  ...
  {
    method: 'delete', path: '/payments/bills/{billId}', tag: TAG.payments, operationId: 'unlinkBill',
  ...
  {
    method: 'put', path: '/payments/bills/{billId}/autopay', tag: TAG.payments,
    operationId: 'configureAutopay', summary: 'Configure or disable autopay',
    pathParams: BILL_ID,
  ...
  {
    method: 'post', path: '/payments', tag: TAG.payments, operationId: 'payBill',
    ...
    errors: [
      ...
      { status: STATUS.unprocessable, description: 'Insufficient funds or below the biller minimum.' },
    ],
  },
  {
    method: 'get', path: '/payments', tag: TAG.payments, operationId: 'listBillPayments',
