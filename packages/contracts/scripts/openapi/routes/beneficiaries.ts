...
export const beneficiariesOperations = defineOperations([
  {
    method: 'get', path: '/beneficiaries', tag: TAG.beneficiaries, operationId: 'listBeneficiaries',
  ...
  {
    method: 'post', path: '/beneficiaries', tag: TAG.beneficiaries, operationId: 'createBeneficiary',
  ...
  {
    method: 'patch', path: '/beneficiaries/{beneficiaryId}', tag: TAG.beneficiaries,
    operationId: 'updateBeneficiary', summary: 'Rename or favourite a payee',
  ...
  {
    method: 'delete', path: '/beneficiaries/{beneficiaryId}', tag: TAG.beneficiaries,
    operationId: 'deleteBeneficiary', summary: 'Remove a payee',
    pathParams: BENEFICIARY_ID,
    response: success(STATUS.noContent, 'Beneficiary removed.'),
    errors: [{ status: STATUS.notFound }],
  },
  {
    method: 'post', path: '/beneficiaries/{beneficiaryId}/verification/deposits',
    tag: TAG.beneficiaries, operationId: 'sendVerificationDeposits',
    summary: 'Send the two micro-deposits (simulated)',
    pathParams: BENEFICIARY_ID,
    response: success(STATUS.ok, 'Verification state after dispatch.', beneficiaryVerificationSchema),
    errors: [{ status: STATUS.notFound }, { status: STATUS.conflict }],
  },
  {
    method: 'post', path: '/beneficiaries/{beneficiaryId}/verification/confirm',
    tag: TAG.beneficiaries, operationId: 'confirmVerificationDeposits',
    summary: 'Confirm the two micro-deposit amounts',
    pathParams: BENEFICIARY_ID,
    request: verifyBeneficiaryRequestSchema,
    response: success(STATUS.ok, 'Verification state after the attempt.', beneficiaryVerificationSchema),
    errors: [
